...
using Matrix6x16f = Eigen::Matrix<float, 6, 16>;
using Matrix16x6f = Eigen::Matrix<float, 16, 6>;
using Matrix17x6f = Eigen::Matrix<float, 17, 6>;
...
using HrepXf = std::pair<Eigen::MatrixXf, Eigen::VectorXf>;